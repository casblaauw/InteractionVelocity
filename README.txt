...
makes it possible to investigate the cellular interaction spaces between different tissues. In particular,
the dynamics of these interaction spaces are well suited to the concept of RNA velocity. Here, we
present a pipeline to map RNA velocities of these interaction spaces.
